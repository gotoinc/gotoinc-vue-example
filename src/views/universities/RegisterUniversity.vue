          ...
          <v-col cols="12" sm="8" md="4">
            <v-card class="elevation-12">
              ...
              <v-card-text>
                <v-form>
                  ...
                  <v-text-field
                    ...
                    :error-messages="
                      universityNameError($v.form.university_name)
                    "
                  ></v-text-field>
                  <v-text-field
                    ...
                    :class="{
                      'clr-error': $v.form.university_description.$error
                    }"
                    :error-messages="
                      universityDescriptionError($v.form.university_description)
                    "
                  ></v-text-field>
                  <v-text-field
                    label="City"
                    ...
                    :error-messages="
                      universityCityError($v.form.university_city)
                    "
                  ></v-text-field>
                </v-form>
              </v-card-text>
              <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <v-btn color="primary" @click.prevent="registerUniversity($v)"
                  >Register university</v-btn
                >
              </v-card-actions>
            </v-card>
          </v-col>
  ...
  methods: {
    registerUniversity(validation) {
      ...
      translateText(this.form.university_description).then(translated => {
        ...
        this.$store
          .dispatch("registerUniversity", dataToSend)
